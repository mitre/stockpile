...
valid_vars = dict(application=['name', 'port', 'is_vulnerable', 'user', 'type'],
                  custom=['bookmark_title', 'bookmark_url', 'bookmark_path', 'organization_name',
                          ...
                          'contact_http', 'git_dir', 'dropbox_api_key', 'dropbox_target_dir', 'github_username',
                          'github_repository', 'github_token', 'github_branch', 'github_url', 'archive_password',
                          'file_size_chunk', 'ftp_username', 'ftp_password', 'ftp_server', 's3_region', 's3_name',
                          's3_bucket', 's3_id', 's3_path', 's3_group', 's3_policy', 'psexec_path', 'host_interface',
                          'netrange', 'https', 'rdp_id', 'agent_args', 'rdp_hosts', 'rdp_users', 'rdp_passwords'],
                  ...
                  file=['name', 'path', 'dir', 'permissions', 'owner', 'modified', 'accessed', 'created', 'extension',
                        ...
                        'is_compressed', 'encryption_key', 'staged_at'],
